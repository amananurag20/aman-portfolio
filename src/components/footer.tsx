    ...
    <footer className=" py-8 md:py-12 w-full">
      <div className="container max-w-7xl flex flex-col items-center justify-center gap-6 md:flex-row md:justify-between">
        <div className="flex items-center gap-4">
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent>
                <p>https://www.linkedin.com/in/aman-anurag-a160441b7</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
        </div>
        <p className="text-sm text-muted-foreground text-center md:text-left">
          Made with ❤️ by{" "}
          <Link href="https://github.com/amananurag20" target="_blank" className="font-medium hover:underline" prefetch={false}>
            Aman Anurag
          </Link>
        </p>
      </div>

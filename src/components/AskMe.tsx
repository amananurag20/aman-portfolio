            ...
            <div className="flex items-center justify-between p-4 border-b border-gray-200/50 dark:border-gray-800/50 backdrop-blur-md">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">Ask me anything about Aman Anurag</p>
                </div>
              </div>
              <button
                onClick={onClose}
              ...
              {messages.length === 0 ? (
                <div className="space-y-6">
                  <div className="flex flex-col items-center justify-center text-gray-500 dark:text-gray-400">
                    ...
                    >
                      Hi! I'm Aman Anurag's AI assistant. How can I help you today?
                    </motion.p>
                  </div>
                ...
                <div className="space-y-6 pb-20">
                  {messages.map((message, index) => (
                    ...
                    >
                      ...
                      {message.role === 'assistant' && message.suggestedQuestions && message.suggestedQuestions.length > 0 && !isLoading && (
                        <motion.div
                          initial={{ opacity: 0, y: 5 }}
                          animate={{ opacity: 1, y: 0 }}
                          transition={{ delay: 0.3 }}
                          className="flex flex-wrap gap-2 mt-4 max-w-[90%]"
                        >
                          {message.suggestedQuestions.map((question, qIndex) => (
                            <motion.button
                              ...
                              className="px-3 py-2 text-xs font-medium text-blue-600 dark:text-blue-400 
            ...
            <div className="absolute bottom-0 left-0 right-0 border-t border-gray-200/50 dark:border-gray-800/50 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md p-4">
              <form onSubmit={(e) => { e.preventDefault(); handleSubmit(); }} className="flex gap-2">
                <input
                  ...
                  placeholder="Ask about Aman's skills, experience, or projects..."

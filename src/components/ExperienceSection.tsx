    ...
    achievements: [
      {
        ...
        highlights: ["Trace Venue", "Electron.js", "desktop application", "offline-first architecture", "cross-platform"]
      },
      {
        text: "Built LeadNest CRM - a full-featured CRM platform with dynamic form builder, rule-based automation engine, real-time notifications using SignalR, and multi-stage lead pipeline management using React 18, TanStack Table, and TailwindCSS.",
        highlights: ["LeadNest CRM", "SignalR", "React 18", "TanStack Table", "TailwindCSS"]
      },
      {
        text: "Developed a drag-and-drop form builder with 15+ field types, multi-step form support, iframe/script embedding for external websites, real-time styling customization, and bulk operations using optimized batch APIs.",
        highlights: ["drag-and-drop form builder", "15+ field types", "multi-step form", "batch APIs"]
      },
      {
        text: "Designed a visual rule builder for lead automation workflows with condition-based triggers, dynamic field selection, and real-time status toggle for rule activation/deactivation.",
        highlights: ["visual rule builder", "lead automation", "condition-based triggers"]
      },
      {
        text: "Implemented real-time push notifications with SignalR featuring auto-reconnection, token-based authentication, toast notifications with clickable actions, and HTML sanitization for secure content handling.",
        highlights: ["real-time push notifications", "SignalR", "token-based authentication", "HTML sanitization"]
      },
      {
        text: "Built comprehensive lead management with multi-stage pipeline view, dynamic form rendering, advanced filter builder, team-based access control, and activity timeline tracking.",
        highlights: ["lead management", "multi-stage pipeline", "advanced filter builder", "access control"]
      },
      {
        text: "Developed role-based access control (RBAC) with granular permissions, user invitation workflow, team hierarchy management, and audit logging for user activity tracking.",
        highlights: ["RBAC", "granular permissions", "team hierarchy", "audit logging"]
      }
    ]
  },
  {
